...
public class MakatiEmergencyHotlinesActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_makati_emergency_hotlines);
        ...
        backButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(MakatiEmergencyHotlinesActivity.this, SelectCityActivity.class);
